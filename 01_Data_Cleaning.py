...
# 1) Load raw data
df = pd.read_csv("/Users/ibrahimbarqawi/Desktop/Data Analysis _Course and projects /Codes/11-workforce-cost-analytics/data/raw/workforce_cost_raw.csv")
...
# ---------------------------
output_path = "/Users/ibrahimbarqawi/Desktop/Data Analysis _Course and projects /Codes/11-workforce-cost-analytics/data/processed/workforce_cost_cleaned.csv"
...
| Column name            | Logic                               |
| ---------------------- | ----------------------------------- |
| `ot_inefficiency_flag` | overtime_cost > 0.25 × base_salary  |
| `high_allowance_flag`  | allowance_cost > 0.40 × base_salary |
| `bonus_month_flag`     | bonus_cost > 0                      |
| `seasonal_cost_flag`   | month in [6, 7, 8]                  |
| Column name            | Logic                               |
| ---------------------- | ----------------------------------- |
| `ot_inefficiency_flag` | overtime_cost > 0.25 × base_salary  |
| `high_allowance_flag`  | allowance_cost > 0.40 × base_salary |
